<?php $title='Sponsor — The Big Draw'; $active='sponsor'; include 'includes/header.php'; ?>

<section class="pagehero"><div class="wrap">
  <div class="tri f" style="--s:20px;--c:var(--gold);right:9%;top:20px;transform:rotate(18deg)"></div>
  <div class="tri f" style="--s:14px;--c:#fff;right:18%;top:78px;transform:rotate(-20deg);opacity:.5"></div>
  <div class="crumb">Choose your impact · Every gift matters</div>
  <h1>Become a Sponsor</h1>
  <p>Put your name on the sand and power mentorship in Central Texas — every gift goes to Big Brothers Big Sisters.</p>
</div></section>
...
<section class="pay"><div class="wrap">
  <p class="note">Ready to sponsor? Choose your level below — and please include the level in the comment section.</p>
  <iframe src="https://host.nxt.blackbaud.com/donor-form?svcid=renxt&formId=edce5290-bfdc-4ab4-8ac5-d089a7d1bfa5&envid=p--K_lwkjaikKw84Z7Hr2ixg&zone=usa" title="Sponsorship donation form"></iframe>
</div></section>
