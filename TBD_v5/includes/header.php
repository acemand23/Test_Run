<?php
  ...
  // ── Registration gating (two divisions) ───────────────────────────────
  //   Community Division  — registration is OPEN now.
  //   Competitive Division — opens Wed, Oct 7, 2026 at 6:00 PM Central. Oct 7 is
  //   still Central DAYLIGHT time (CDT = UTC-5; DST ends Nov 1), so the instant is
  //   -05:00. The countdown + Competitive CTAs flip automatically at that moment.
  ...
  // Primary "Register" destination (home poster hotspot): the live signup now that
  // Community is open, otherwise the on-site holder page.
  $register_url = $community_is_open ? $reg_signup_url : 'register.php';
?><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
